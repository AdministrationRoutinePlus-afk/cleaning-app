      ...
      <div className="w-full max-w-md text-center bg-white/5 border border-white/10 rounded-xl">
        ...
        <div className="px-6 pb-4 space-y-4">
          <p className="text-gray-300">
            {t('An employer needs to activate your account before you can access the marketplace and start claiming jobs.')}
          </p>
          <p className="text-sm text-gray-400">
            {t('You will be notified once your account is activated.')}
          </p>
        </div>
